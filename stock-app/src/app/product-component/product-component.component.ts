...
export class ProductComponent implements OnInit {
  products: Product[] = [];
  newProduct: Product = { name: '', reservedItems: undefined, availableItems: undefined};
  updateProductData: Product = { id: undefined, name: '', availableItems: undefined, reservedItems: undefined};
  productById?: Product;
  searchId: number = 0;
